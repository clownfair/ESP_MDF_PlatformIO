...
#include "esp_wifi.h"
#include "../third_party/miniz/include/miniz.h"
#include "mbedtls/md5.h"
#include "mbedtls/aes.h"

#include "../mcommon/include/mdf_common.h"
#include "../mespnow/include/mespnow.h"
#include "../mconfig/include/mconfig_security.h"
#include "../mconfig/include/mconfig_queue.h"
#include "../mconfig/include/mconfig_chain.h"
...
static void mconfig_chain_master_task(void *arg)
{
    ...
    while ((xTaskGetTickCount() - start_ticks) < g_chain_master_duration_ticks) {
        ...
        MDF_LOGW("size: %d, espnow_data: %s", espnow_size, espnow_data);
        sprintf(pubkey_pem, PEM_BEGIN_PUBLIC_KEY "%s" PEM_END_PUBLIC_KEY, espnow_data);
        MDF_LOGW("pubkey_pem: %s", pubkey_pem);
        ...
        MDF_LOGW("whitelist_size: %d encrypted_size: %d, chain_data:" MACSTR,
...
static void mconfig_chain_slave_task(void *arg)
{
    ...
    MDF_LOGW("privkey_pem: %s, pubkey_pem: %s", privkey_pem, pubkey_pem);
